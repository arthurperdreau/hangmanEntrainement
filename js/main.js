...
//function drawBodyPart(x,y,w,z){ --> autre solution pour dessiner le pendu. La fonction bras va appeler la cette fonction avec les bonnes coordonnees
//dessin.moveTo(x, y)
//dessin.lineTo(w,z)
//dessin.stroke()
...
function jambe(){
    dessin.moveTo(70, 80)
    dessin.lineTo(90,110)
    dessin.stroke()
}
function autreJambe(){
    dessin.moveTo(70, 80)
    dessin.lineTo(50,110)
    dessin.stroke()
}
initGame()
